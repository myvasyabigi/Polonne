...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('articles_article', 'source', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Article.source'
        db.delete_column('articles_article', 'source')
    ...
    models = {
        'articles.article': {
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['articles.Tags']", 'null': 'True', 'blank': 'True'}),
